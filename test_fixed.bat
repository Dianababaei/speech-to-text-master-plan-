...
echo.
curl -X POST "http://127.0.0.1:8080/jobs/" -H "X-API-Key: %API_KEY%" -F "audio_file=@C:\Users\digi kaj\Downloads\63148.mp3" -F "language=fa" > test_job.json
...
echo ============================================
curl "http://127.0.0.1:8080/jobs/%JOB_ID%" -H "X-API-Key: %API_KEY%" > test_result.json
