...
@pytest.fixture
def db_with_jobs(db_session) -> Session:
...
@pytest.fixture
def db_with_api_keys(db_session) -> Session:
...
@pytest.fixture
def db_with_lexicon_terms(db_session) -> Session:
...
@pytest.fixture
def db_with_feedback(db_session, db_with_jobs) -> Session:
...
@pytest.fixture
def mock_app_dependencies(db_session, mock_redis_queue):
...
@pytest.fixture
def integration_test_setup(db_session, mock_redis_queue, mock_openai_success):
    """
